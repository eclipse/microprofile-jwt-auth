 ...
 *
 */
package org.eclipse.microprofile.jwt.tck.servlet;
...
import org.eclipse.microprofile.jwt.tck.ejb.IService;
...
public class ServiceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.printf("pathInfo=%s, userIsJWTPrincipal: %s\n", pathInfo, (user instanceof JWTPrincipal));

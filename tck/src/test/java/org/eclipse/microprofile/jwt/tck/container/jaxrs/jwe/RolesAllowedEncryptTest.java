 ...
 */
public class RolesAllowedEncryptTest extends Arquillian {
    ...
    public static void generateToken() throws Exception {
        token = encryptClaims("/Token1.json");
    }
    
    private static String encryptClaims(String jsonResName) throws Exception {
        return TokenUtils.encryptClaims(jsonResName);
    }
    ...
    public void callEchoSignToken() throws Exception {
        ...
        String signToken = TokenUtils.signClaims("/Token1.json");
    ...
    public void checkIsUserInRoleToken2() throws Exception {
        ...
        String token2 = encryptClaims("/Token2.json");

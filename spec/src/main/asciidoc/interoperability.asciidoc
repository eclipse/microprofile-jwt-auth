...
current complete set of valid claim types is therfore, (excluding the invalid Claims.UNKNOWN Void type):
* java.lang.String
* java.lang.Long
* java.lang.Boolean
...
with `@Dependent` scoping for any CDI defined non-proxyable type. For currently defined standard
claims, the set of non-proxyable types include:
* java.lang.String
* java.lang.Long
* java.lang.Boolean
* java.util.Optional
...
----
<0> Injection of a non-proxyable raw type like java.lang.Long must happen in a RequestScoped bean as
...
<6> Another inection of a non-proxyable raw type like java.lang.Long, but the use of the javax.inject.Provider interface

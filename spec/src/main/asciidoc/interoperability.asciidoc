...
alg:: This JOSE header parameter identifies the cryptographic algorithm used to secure the JWT. RSASSA-PKCS1-v1_5 SHA-256 algorithm is required for signing the claims and must be specified as "RS256", https://tools.ietf.org/html/rfc7515#section-4.1.1[RFC7515, Section 4.1.1]. RSAES using Optimal Asymmetric Encryption Padding and AES in Galois/Counter Mode (GCM) algorithms are required for
encrypting the claims and must be specified as "RSA-OAEP", https://tools.ietf.org/html/rfc7518#section-4.3[RFC7518, Section 4.3] and "A256GCM", https://tools.ietf.org/html/rfc7518#section-5.3[RFC7518, Section 5.3]
